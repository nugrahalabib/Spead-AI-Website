...
const ScrollProgress = () => {
    ...
    return (
        <motion.div
            className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-amber-400 via-orange-500 to-amber-400 origin-left z-50"
            style={{ scaleX }}
        />
    );
};

export default function BlogArticleLayout({ post }: { post: any }) {
    ...
    return (
        <div className="min-h-screen bg-[#020617] text-white selection:bg-amber-500/30 overflow-hidden font-[family-name:var(--font-outfit)]">
            <ScrollProgress />
            ...
            <div className="fixed inset-0 z-0 pointer-events-none">
                ...
                <motion.div
                    ...
                    className="absolute top-0 right-0 w-[800px] h-[800px] bg-amber-900/20 blur-[100px] rounded-full opacity-30"
                />
                <motion.div
                    animate={{ x: [0, -100, 0], y: [0, 50, 0] }}
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <header className="mb-16">
                        <div className="flex flex-wrap items-center gap-4 text-xs font-mono text-slate-400 mb-6 uppercase tracking-wider">
                            ...
                            {post.category && (
                                <span className={`flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-amber-400`}>
                        ...
                        {post.image && (
                            <motion.div
                                ...
                                className="relative w-full aspect-video rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-amber-500/10 group"
                            >
                    ...
                    {post.key_takeaways && (
                        <motion.div
                            ...
                            className="mb-16 relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-900/20 via-slate-900/40 to-slate-900/20 border border-amber-500/20 p-8 md:p-10"
                        >
                            <div className="absolute top-0 right-0 p-4 opacity-20">
                                <Cpu size={120} className="text-amber-500" />
                            </div>
                            <h3 className="relative z-10 text-xs font-bold text-amber-400 mb-6 uppercase tracking-[0.2em] font-mono flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" />
                                Executive Summary
                            </h3>
                            <div className="relative z-10 text-slate-200 prose prose-invert prose-p:leading-relaxed prose-li:marker:text-amber-500">
                    ...
                    <motion.article
                        ...
                        prose-a:text-amber-400 prose-a:no-underline hover:prose-a:text-amber-300 prose-a:border-b prose-a:border-amber-500/30 hover:prose-a:border-amber-500
                    ...
                    <div className="mt-20 pt-10 border-t border-white/10">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex gap-4">
                                <button className="p-3 rounded-full bg-white/5 hover:bg-white/10 text-slate-400 hover:text-amber-400 transition-colors">
                                    <Share2 size={18} />
                                </button>
                                <button className="p-3 rounded-full bg-white/5 hover:bg-white/10 text-slate-400 hover:text-amber-400 transition-colors">
