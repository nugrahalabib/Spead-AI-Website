...
print("📦 Patching: Creating div_visuals...")
payload = {
    "field": "div_visuals",
    "type": "alias",
    "meta": {
        "interface": "presentation-divider",
        "options": { "title": "Visuals" },
        "sort": 20,
        "special": ["alias", "no-data"]
    }
}

res = request('POST', '/fields/lp_hero', payload, token)
if 'error' in res:
    print(f"❌ Failed to create div_visuals: {res}")
    sys.exit(1)
else:
    print("✅ Success: div_visuals created.")
